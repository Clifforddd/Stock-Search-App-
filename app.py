...
def stock():
    ...
    try:
        if "symbol" not in request.args:
            ...
            price = {'Name':ticker.info['shortName'], 'Symbol': ticker.info['symbol'], 
            'Current Price':ticker.info['currentPrice'], 'Earnings Growth': ticker.info['earningsGrowth'],
            'Current Ratio':ticker.info['currentRatio'], 'Profit Margins': ticker.info['profitMargins']   
            }
